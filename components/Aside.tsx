...
export default function Aside() {
  return (
    <aside
      id="aside"
      className="max-lg:hidden h-screen overflow-y-auto sticky top-0 z-10 shrink-0 text-[#404040] dark:text-[#e5e5e5] bg-[#fafafa] dark:bg-[#171717] border-r border-[#EEEFF2] dark:border-[#262626]"
    >
